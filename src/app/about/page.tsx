...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center text-black pt-10 pb-10">
      <div className="w-[90%] md:w-[70%] p-8 border-2 border-black bg-white shadow-[8px_8px_0px_rgba(0,0,0,1)] relative">
        ...
        >
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
            <div className="w-32 h-32 border-2 border-black bg-gray-100 flex items-center justify-center shadow-[4px_4px_0px_rgba(0,0,0,1)]">
              <span className="text-4xl">👨‍💻</span>
            </div>
            <div>
              <h1 className="text-4xl font-bold mb-2">Hey, I'm Kyle</h1>
              <p className="text-xl text-gray-700">Software Engineer building things that matter</p>
            </div>
          </div>
        </section>
        ...
        >
          <h2 className="text-2xl font-bold mb-4 border-b-2 border-black pb-2">My Story</h2>
          <div className="space-y-4 text-lg leading-relaxed">
            ...
            <p>
              After graduating in 2023, I joined Epsilon as a Software Engineer, where I've been 
        ...
        >
          <h2 className="text-2xl font-bold mb-4 border-b-2 border-black pb-2">What Drives Me</h2>
          <div className="space-y-4 text-lg leading-relaxed">
            <p>
        ...
        >
          <h2 className="text-2xl font-bold mb-4 border-b-2 border-black pb-2">When I'm Not Coding</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div
                key={index}
                className="p-4 border-2 border-black bg-white shadow-[4px_4px_0px_rgba(0,0,0,1)] text-center hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_rgba(0,0,0,1)] transition-all duration-150"
              >
        ...
        >
          <h2 className="text-2xl font-bold mb-4 border-b-2 border-black pb-2">Let's Connect</h2>
          <div className="flex flex-wrap gap-4">
            <a
              href="https://github.com"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2 border-2 border-black bg-white shadow-[4px_4px_0px_rgba(0,0,0,1)] font-semibold hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_rgba(0,0,0,1)] transition-all duration-150"
            >
            ...
            <a
              href="mailto:kyle.morimoto@example.com"
              className="inline-flex items-center gap-2 px-4 py-2 border-2 border-black bg-white shadow-[4px_4px_0px_rgba(0,0,0,1)] font-semibold hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_rgba(0,0,0,1)] transition-all duration-150"
            >
